...
const Biodata = () => {
  ...
  return (
    <div className="max-w-screen min-h-screen">
      ...
      <div className="my-10 flex max-w-screen flex-col items-center justify-center rounded-lg border-2 border-[#E0E0E0] md:mx-auto md:max-w-6xl">
        ...
        <div className="flex w-full items-center md:space-x-40 space-x-10 border-b-2 border-[#E0E0E0] px-10 py-4">
          <p className="text-[#bdbdbd]">Photo</p>
          <img src={image!} className="h-24 w-24 rounded-full" alt="" />
        </div>
        <div className="flex h-[73.26px] w-full items-center md:space-x-40 space-x-10 border-b-2 border-[#E0E0E0] px-10 py-4">
